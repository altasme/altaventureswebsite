...
- `Agitation`'s `turnLine` and `OfferPortfolio`'s first project now get asymmetric featured treatment (a solid-blue pull-quote panel; a large side-by-side featured card, real-screenshot `altamotors` promoted to that slot ahead of the four still-placeholder projects) instead of uniform stacked blocks.
