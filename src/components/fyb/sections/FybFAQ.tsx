...
import { FYB_FAQ } from "../../../content/foryourbusiness";
import Section from "../../ui/Section";

export default function FybFAQ() {
  ...
  return (
    <Section tone="alt">
      ...
      <div className="mt-10 max-w-prose divide-y divide-ink/8 border-y border-ink/8">
        {FYB_FAQ.items.map((item, i) => {
          const isOpen = openIndex === i;
          const panelId = `fyb-faq-panel-${i}`;
          const buttonId = `fyb-faq-button-${i}`;
