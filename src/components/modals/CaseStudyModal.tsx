...
import { CASE_STUDY_DETAILS } from "../../content/site";
...
export default function CaseStudyModal() {
  ...
  const project = PORTFOLIO_BY_ID[caseStudyProject];
  const details = CASE_STUDY_DETAILS[caseStudyProject];
  ...
  return (
    ...
    >
      ...
      >
        ...
        <p className="mb-8 text-base leading-relaxed text-ink/80">{details.overview}</p>
