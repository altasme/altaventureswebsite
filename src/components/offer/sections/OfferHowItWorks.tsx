    ...
    <Section tone="alt">
      ...
      <ol className="mt-10 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
        {OFFER_HOW_IT_WORKS.steps.map((step) => (
          <li key={step.number} className="rounded-2xl bg-white p-6 shadow-sm">
            <span className="text-3xl font-extrabold text-brand-blue/25">{String(step.number).padStart(2, "0")}</span>
