  ...
  return (
    <section className="bg-brand-navy-deep text-white">
      <div className="mx-auto max-w-4xl px-6 py-20 text-center sm:py-28 lg:px-8">
        ...
        <p className="mt-4 text-2xl font-bold text-white sm:text-3xl">{OFFER_HERO.sub}</p>
        <p className="mx-auto mt-6 max-w-xl text-lg text-white/80">{OFFER_HERO.support}</p>
