  ...
  return (
    <section className="relative overflow-hidden bg-brand-navy-deep text-white">
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(90deg, rgba(6,18,46,0.95) 0%, rgba(6,18,46,0.88) 40%, rgba(6,18,46,0.55) 70%, rgba(6,18,46,0.3) 100%)",
        }}
      />
      <div
        className="pointer-events-none absolute inset-0"
        style={{ background: "linear-gradient(180deg, rgba(6,18,46,0.2) 0%, rgba(6,18,46,0.5) 100%)" }}
      />

      <div className="relative mx-auto max-w-6xl px-6 py-16 sm:py-20 lg:px-8 lg:py-28">
