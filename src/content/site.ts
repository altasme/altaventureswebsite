...
export const HERO = {
  ...
  // TODO(asset): real hero photography not yet supplied. Placeholders
  // generated by scripts/gen-placeholders.mjs, matching the construction
  // technique used on Vocalyze/Lean & Fit: subject positioned to one side
  // of the frame (right on desktop, lower on mobile) so the gradient scrim
  // does the legibility work without covering the subject. For Altaventures
  // the "subject" should be a real product screenshot (Setmona, Altamotors,
  // etc.) or a real team/workspace photo, not stock imagery (CLAUDE.md §0.7).
  backgroundImageDesktop: "/images/hero/hero-bg-wide.jpg",
  backgroundImageMobile: "/images/hero/hero-bg-mobile.jpg",
  backgroundAlt: "TODO(asset): describe the real photo once supplied",
} as const;
